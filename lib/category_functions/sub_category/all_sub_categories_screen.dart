...
class AllSubCategoriesScreen extends StatefulWidget {
  @override
  _AllSubCategoriesScreenState createState() =>
      _AllSubCategoriesScreenState();
}
...
class _AllSubCategoriesScreenState extends State<AllSubCategoriesScreen> {
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(
                                    width: 120,
                                    height: 120,
                                    child: subCategoriesList[index].icon == null ? Container(
                                      ...
                                      child: CachedNetworkImage(
                                        fit: BoxFit.cover,
                                        imageUrl: subCategoriesList[index].icon,
                                                ...
                                                onPressed: () {
                                                  ...
                                                  Navigator.of(context)
                                                      .push(new MaterialPageRoute(builder: (context) =>
                                                        EditSubCategoryScreen(subCategoryObj: subCategoriesList[index])));
                                                        ...
                                                        child: Column(
                                                          children: <Widget>[
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text('Are you sure want to delete this sub-category ?',
                                                              ...
                                                              children: [
                                                                RaisedButton(
                                                                  ...
                                                                  onPressed: () {
                                                                    ...
                                                                    _deleteCategory(cxt, subCategoriesList[index].categoryId,
  ...
  void _deleteCategory(BuildContext cxt, String categoryId, String subCategoryId) {
    ...
    fireStoreInstance.collection("categories")
        .doc(categoryId)
        .collection("sub_categories")
        .doc(subCategoryId).delete().then((_) {
  ...
  deleteCategoryItemFromList(String id) {
    ...
    if(keyIndex != -1)
      subCategoriesList.removeAt(keyIndex);
