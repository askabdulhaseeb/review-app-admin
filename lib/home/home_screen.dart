            ...
            children: [
              ...
              CustomButton2('Category', (){
                ...
                Navigator.of(context)
                    .push(new MaterialPageRoute(builder: (context) => CategoryFunctionsScreen()));
              ...
              CustomButton2('Users', (){
                ...
                Navigator.of(context)
                    .push(new MaterialPageRoute(builder: (context) => AppUsersScreen()));
              ...
              CustomButton2('View Products', (){
                ...
                Navigator.of(context)
                    .push(new MaterialPageRoute(builder: (context) => ViewProductsScreen()));
